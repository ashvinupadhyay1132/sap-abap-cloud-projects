...
CLASS zcl_rap_test_runner IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    " -------------------------------------------------------------------
    " 1. SIMULATING EML (ENTITY MANIPULATION LANGUAGE) CREATE IN RAP
    " -------------------------------------------------------------------
    out->write( '[EML TEST 1]: Triggering RAP Entity Creation (ZCDS_I_TRAVEL_M)...' ).

    " EML Create Syntax simulation
    ...
    " -------------------------------------------------------------------
    " 2. VALIDATION TRIGGERING (validateCustomer & validateDates)
    " -------------------------------------------------------------------
    out->write( '----------------------------------------------------------------------------------------' ).
